...
export default class BookController {
    ...
    static editBook(req, res) {
        const bookEditId = req.params.id;
        ...
        const updatedBook = Object.assign(Object.assign({}, books[foundBookIndex]), { name: name ? name.trim() : books[foundBookIndex].name, author: author ? author.trim() : books[foundBookIndex].author, description: description ? description.trim() : books[foundBookIndex].description, photo: photo ? photo.trim() : books[foundBookIndex].photo });
